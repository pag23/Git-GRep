...
/****** Object:  View [dbo].[extract_cds_out_010_adhoc]    Script Date: 09/27/2016 14:02:23 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[extract_cds_out_010_adhoc] AS
...
SELECT [CDS_Type]
      ...
      --,[mod_date]
      --,[hash__value]
  FROM [dbo].[extract_cds_adhoc_out_sync] --[extract_cds_out_history_SSIS]
 -- WHERE [mod_date] =
 -- (
	--SELECT MAX([mod_date]) FROM [test_CDS_db].[dbo].[extract_cds_out_history_SSIS]
 -- )

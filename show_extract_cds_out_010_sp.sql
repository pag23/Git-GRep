...
/****** Object:  StoredProcedure [dbo].[show_extract_cds_out_010_sp]    Script Date: 09/27/2016 14:01:17 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[show_extract_cds_out_010_sp] 
(
@mod_date as datetime
)
AS
/******
PAG 24/05/2016 
...
SELECT [CDS_Type]
  ...
  WHERE CAST(CAST([mod_date]  AS DATE) AS DATETIME) = CAST(@mod_date AS DATETIME)
